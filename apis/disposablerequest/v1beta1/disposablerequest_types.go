...
func (mg *DisposableRequest) SetManagementPolicies(mp xpv1.ManagementPolicies) {
...
func (in *DisposableRequestList) DeepCopyInto(out *DisposableRequestList) {
	...
	out.Items = append([]DisposableRequest(nil), in.Items...)
}
